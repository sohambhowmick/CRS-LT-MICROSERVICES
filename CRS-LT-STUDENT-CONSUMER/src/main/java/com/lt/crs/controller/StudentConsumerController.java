...
public class StudentConsumerController {
	...
	public String registerCourseToStudent(@RequestBody Map<String, Object> registeredCourseMap) throws RestClientException, IOException {
	...
	public String viewRegisteredCourses(@RequestParam("studentId") int studentId) throws RestClientException, IOException {
